...
class ProductView(View):
	def get(self, request):
		...
		return render(request, 'app/home.html', {'topwears':topwears, 'bottomwears':bottomwears, 'mobiles':mobiles, 'totalitem':totalitem,'laptop':laptop})
...
def mobile(request, data=None):
	...
	if data==None :
			mobiles = Product.objects.filter(category='M')
	elif data == 'vivo' or data == 'oppo' or data == 'apple':
...
def laptop(request, data=None):
    ...
    if data is None:
        laptop = Product.objects.filter(category='L')  
    elif data == 'apple' or data == 'dell' or data == 'hp':
